            ...
            <ul>
                @foreach ($errors->all() as $error)
                    ...
                    @elseif($error == 'The student image field has invalid image dimensions.')
                        <li>Las dimensiones de la imagen no son validas. Debe seleccionar una imagen con dimenciones minimas
                            100x100 y maximas 1000x1000.</li>
                    @else
                        <li>{{ $error }}</li>
                    @endif
                @endforeach
            ...
            <form method="post" action="{{ route('applications.store') }}" enctype="multipart/form-data">
                ...
                <div class="row mb-4">
                    ...
                    <div class="col-sm-10">
                        ...
                        <input id="autocomplet_student" type="text" class="form-control"
