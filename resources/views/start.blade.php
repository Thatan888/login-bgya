    ...
    <nav class="navbar navbar-light bg-white  navbar-expand-md">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav3">
                ...
                <a class="btn btn-success ml-md-3" href="{{ route('home.app') }}">App</a>
            </div>
        </div>
    </nav>
        ...
        <div class="container pt-5 pb-5 position-relative">
            <div class="row d-flex justify-content-between pt-lg-5 align-items-center">
                <div class="col-xl-5 col-lg-6 col-md-7 text-center text-lg-left mb-5 mb-lg-0">
                    <h1 class="display-3 font-weight-bold text-white aos-init aos-animate" data-aos="fade-up">Build
                        better websites faster</h1>
                    <div class="my-4 aos-init" data-aos="fade-up">
                        <p class="lead text-white">Easily create website layouts, templates, wireframes, mockups in less
                            time and zero coding!</p>
                    </div>
                        ...
                        <div class="col-xl-8 col-md-10">
                            <form class="position-relative d-block aos-init aos-animate" data-aos="fade-up">
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col">
                                            <div class="form-group rounded bg-white p-2 border">
                                                <div class="custom-control custom-radio">
                                                    <input type="radio" id="course-radio-beginner-1"
                                                        name="course-radio-1" class="custom-control-input">
                                        ...
                                        <div class="col">
                                            <div class="form-group rounded bg-white p-2 border">
                                                <div class="custom-control custom-radio">
                                                    <input type="radio" id="course-radio-advanced-1"
                                                        name="course-radio-1" class="custom-control-input">
                                                    <label class="custom-control-label"
                                ...
                                <div class="form-group text-center">
                                    <button class="btn btn-lg btn-success btn-block mb-2" type="submit">Claim your
                                        free spot</button>
                                    <small class="text-white">You’ll recieve your first lesson via email in less than a
                                        minute.</small>
                                </div>
                            </form>
                        </div>
    ...
    <section class="pt-5 pb-5 bg-light" style="">
        <div class="container  pt-5 pb-5">
            <div class="row d-flex justify-content-between">
                <div class="col-md-6">
                    <h3 class="display-4 font-weight-bold aos-init" data-aos="fade-up">Start building beautiful
                        websites</h3>
                    <p class="lead mt-4 aos-init" data-aos="fade-up">Lorem ipsum dolor sit amet, consectetur
                        adipiscing elit, sed do eiusmod tempor incididunt.</p>
                    <div class="row row-grid">
                        <div class="col-xs-4 col-md-4 my-1 aos-init" data-aos="fade-up">
                            <img src="https://via.placeholder.com/150x45/ccc/ffffff&text=IMG LOGO" alt=""
                                class="img-fluid">
                        </div>
                        <div class="col-xs-4 col-md-4 my-1 aos-init" data-aos="fade-up">
                            <img src="https://via.placeholder.com/150x45/ccc/ffffff&text=IMG LOGO" alt=""
                                    ...
                                    <div class="row   justify-content-center d-flex  ">
                                        <div class="col-md-12  card px-5 text-dark py-5">
                                            ...
                                            <blockquote class="blockquote blockquote-reverse mt-4">
                                                <p class="lead font-weight-bold mt-2">"Lorem ipsum dolor sit amet,
                                                    consectetur adipiscing eliterat sed".</p>
            ...
            <div class="row justify-content-center">
                <div class="col col-md-8 text-center aos-init" data-aos="fade-up" data-aos-offset="300">
                    ...
                    <p class="text-h3">Vivamus sagittis lacus vel augue laoreet rutrum faucibus dolor auctor. Duis
                        mollis, est non commodo luctus. Vivamus sagittis lacus vel augue laoreet rutrum faucibus dolor
                        auctor.
                        <a href="http://bootstraptor.com">Duis mollis</a>.
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row align-items-center justify-content-center">
                <div class="col-12 col-md-6   mt-4 mt-md-0">
                    <img alt="image" class="img-fluid rounded d-block mx-auto shadow aos-init"
                        data-aos="fade-right" data-aos-offset="300" src="http://via.placeholder.com/410x450/ccc/fff">
                </div>
                <div class="col-12 col-md-5">
                    <h2 data-aos="fade-up" class="aos-init">Nice Heading</h2>
                    <p class="text-h3 mt-3 lead aos-init" data-aos="fade-up">A collection of coded HTML and CSS
                        elements to help your build your new website. Clean design, fully responsive and based on
                        Bootstrap 4.</p>
                    <ol class="list-unstyled mt-4">
                        <li class="d-flex mb-2 mt-2 aos-init" data-aos="fade-up">
                            <i class="fas fa-check-circle fa-lg text-info mr-1 mt-2 mb-2 ml-0"
                                aria-hidden="true"></i><span class="pl-2 pt-1">Very Important Point</span>
                        </li>
                        <li class="d-flex mb-2 mt-2 aos-init" data-aos="fade-up">
                            <i class="fas fa-check-circle fa-lg text-info mr-1 mt-2 mb-2 ml-0"
                                aria-hidden="true"></i><span class="pl-2 pt-1">Another Key Point</span>
                        </li>
                        <li class="d-flex mb-2 mt-2 aos-init" data-aos="fade-up">
                            <i class="fas fa-check-circle fa-lg text-info mr-1 mt-2 mb-2 ml-0"
                                aria-hidden="true"></i><span class="pl-2 pt-1">Another Key Point</span>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-12 col-md-8 text-center">
                    <h3 class="mb-5 display-5 font-weight-bold aos-init" data-aos="fade-up">Frequently asked questions
                        (FAQ)</h3>
                    ...
                    <div class="">
                        <div class="row text-center justify-content-center">
                            <div class="col-12 col-md-9 col-lg-7 aos-init" data-aos="fade-up">
                                ...
                                <p class="text-h3 lead">Fusce dapibus, tellus ac cursus commodo, tortor mauris
                                ...
                                <div class="row justify-content-center">
                                    <div class="col-xl-8 col-md-10">
                                        <form>
                                            ...
                                            <div class="form-group text-center">
                                                <button class="btn btn-lg btn-success btn-block mb-2"
                                                    type="submit">Claim your free spot</button>
                                                <small class=" ">You’ll recieve your first lesson via email in
                                                    less than a minute.</small>
                                            </div>
                                        </form>
                                    </div>
                                </div>
        ...
        <div class="footer text-white">
            <div class="   bg-dark pt-5 pb-5">
                <div class="container">
                    <div class="row mb-5">
                        <div class="col">
                            <div class="card card-body border-0 mb-0 bg-danger text-light px-md-5 py-md-4 shadow-lg aos-init"
                                style="overflow:hidden" data-aos="zoom-out-down">
                                <div
                                    class="position-relative d-flex flex-column py-md-2 flex-md-row justify-content-between align-items-center">
                                    <div class="h3 text-center mb-md-0">Start building beautiful websites FASTER!</div>
                                    <a href="https://gumroad.com/blueprintsapp"
                                        class="btn btn-lg btn-light py-md-3 px-md-5 text-danger font-weight-bold">
                                        GET MORE TEMPLATES
                                    </a>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-xs-6 col-sm-3">
                            <a href="#">
                                <svg class="d-block mb-4" width="36" height="36" viewBox="0 0 612 612"
                                ...
                                <div class="form-group">
                                    <div class="input-group mb-3">
                                        <input type="text" class="form-control form-control-sm"
                                            placeholder="Email" aria-label="Email" aria-describedby="basic-addon2">
